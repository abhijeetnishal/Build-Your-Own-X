...
exports.deletePost = exports.updatePost = exports.producePostToKafka = exports.saveSchedulePost = exports.savePost = exports.getAllFollowingUsersPosts = exports.getAllPosts = exports.getPostDetails = void 0;
const scheduledPostModel_1 = require("../models/scheduledPostModel");
const kafka_1 = require("../infra/kafka");
...
const producePostToKafka = (post) => __awaiter(void 0, void 0, void 0, function* () {
    const message = { post: JSON.stringify(post) };
    yield kafka_1.producer.produce("schedule_post", message);
});
exports.producePostToKafka = producePostToKafka;
